...
export default function InicializarClientePage() {
  ...
  return (
    <div className="container mx-auto py-10">
      <h1 className="text-3xl font-bold mb-6">Inicializar Módulo de Cliente</h1>

      <Card className="mb-6">
        <CardHeader>
          <CardTitle>Inicialización de Tablas de Cliente</CardTitle>
          <CardDescription>
            Este proceso creará las tablas necesarias para el funcionamiento del módulo de cliente.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p className="text-sm text-muted-foreground mb-4">Se crearán las siguientes tablas si no existen:</p>
          <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
            <li>client_vehicles - Vehículos del cliente</li>
            <li>client_appointments - Citas del cliente</li>
            <li>service_history - Historial de servicios</li>
          </ul>
        </CardContent>
        <CardFooter>
