...
export function MaterialesReparacion() {
  const [materiales, setMateriales] = useState<Material[]>([
    {
      ...
      costo: 250,
      minimo: 5,
      ubicacion: "Estante E, Nivel 1",
      descripcion: "Masilla plástica para reparación de carrocería",
      proveedor: "Distribuidora XYZ",
      fecha_compra: "2023-03-18",
    ...
    },
    {
      ...
      costo: 10,
      minimo: 20,
      ubicacion: "Estante F, Nivel 2",
      descripcion: "Lija grano 400 para preparación de superficies",
      proveedor: "Distribuidora ABC",
      fecha_compra: "2023-03-22",
      fecha_vencimiento: "",
    ...
    },
    {
      ...
      costo: 30,
      minimo: 10,
      ubicacion: "Estante G, Nivel 1",
      descripcion: "Cinta de enmascarar de 18mm x 50m",
      proveedor: "Distribuidora XYZ",
    ...
    },
    {
      ...
      costo: 90,
      minimo: 3,
      ubicacion: "Estante H, Nivel 1",
      descripcion: "Papel de enmascarar de 90cm x 20m",
      proveedor: "Distribuidora ABC",
    ...
    },
    {
      ...
      costo: 130,
      minimo: 3,
      ubicacion: "Estante I, Nivel 2",
      descripcion: "Desengrasante para preparación de superficies",
      proveedor: "Distribuidora XYZ",
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-bold">Materiales de Reparación</h2>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col justify-center items-center h-64 border border-dashed rounded-lg">
          <p className="text-muted-foreground mb-4">No hay materiales de reparación registrados</p>
          <Button onClick={handleAddMaterial}>
      ...
      <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
        <DialogContent className="sm:max-w-[800px]">
          <DialogHeader>
            <DialogTitle>Nuevo Material de Reparación</DialogTitle>
            <DialogDescription>
            ...
            <div className="grid grid-cols-2 gap-4 py-4">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {currentMaterial.tipo === "reparacion" ? "Material de Reparación" : currentMaterial.tipo}
                </p>
              </div>
              <div>
